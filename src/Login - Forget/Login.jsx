...
const Login = () => {
  ...
  const handleForgotPassword = () => {
    setExiting(true);
    setTimeout(() => navigate("/forgot-password"), 400);
  };
          ...
          <form onSubmit={handleSubmit} 
            ...
            <div>
              ...
              <input
                id="email"
                type="email"
                className="w-full rounded-lg border border-swamp-green bg-transparent px-4 py-3 text-sm outline-none transition focus:ring-2 focus:ring-swamp-green"
              />
            </div>
            ...
            <div className="py-4">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-lg border border-swamp-green bg-transparent px-4 py-3 pr-12 text-sm outline-none transition focus:ring-2 focus:ring-swamp-green"
                />
            ...
            <button
              type="submit"
              className="font-Handpicked-seashells w-full rounded-full border border-[#a5b78d] py-3 text-lg font-bold text-swamp-green transition hover:bg-[#91a77a] hover:text-white"
            >
              Login
            </button>
